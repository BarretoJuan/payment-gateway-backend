...
export class AlterTableUserAddBalance1740002342422 implements MigrationInterface {
    name = 'AlterTableUserAddBalance1740002342422'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "USER-COURSE" ADD "cancellation_reason" character varying`);
        await queryRunner.query(`ALTER TABLE "USER" ADD "balance" numeric`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "USER-COURSE" DROP COLUMN "cancellation_reason"`);
    }
