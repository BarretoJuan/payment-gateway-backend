...
export class AlterTableUserAddCancelledStatus1740002705637 implements MigrationInterface {
    name = 'AlterTableUserAddCancelledStatus1740002705637'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."USER-COURSE_status_enum" RENAME TO "USER-COURSE_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."USER-COURSE_status_enum" AS ENUM('completed', 'in_process', 'rejected', 'ready_to_be_checked', 'cancelled')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."USER-COURSE_status_enum_old" AS ENUM('completed', 'in_process', 'ready_to_be_checked', 'rejected')`);
